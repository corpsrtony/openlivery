...
import { ArrowRight, Facebook, Globe2, Instagram, MessageCircle, QrCode, Send, type LucideIcon } from "lucide-react";
import { PageHead } from "@/components/ui";
import { api } from "@/lib/api";
import { useT } from "@/lib/i18n";
import type { Client } from "@/types";

const socialChannels: { key: "instagram" | "messenger"; icon: LucideIcon; className: string }[] = [
  { key: "instagram", icon: Instagram, className: "instagram" },
  { key: "messenger", icon: Facebook, className: "facebook" },
];
